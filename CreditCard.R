...
options(scipen=999)
#Read the file
data=read.csv("C:\\Users\\Tressy\\Desktop\\Learn\\R LEARN\\Datasets\\creditcard.csv")
summary(data)
...
#3. XGBOOST
library(xgboost)
SMOTE_ds$Class=ifelse(MWMOTE_ds$Class=='Normal',0,1)
...
predClass.svm=predict(svm.model,test_data[,c(attr)])
MWMOTEsvm.cm=confusionMatrix(predClass.svm,test_data$Class)
